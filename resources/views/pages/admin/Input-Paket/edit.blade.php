        ...
        <div class="row">
            ...
            <div class="col-12">
                ...
                <div class="card shadow">
                    <div class="card-body">
                        <form class="form-horizontal form-material mx-2" action="{{ route('edit-paket', $item->id) }}"
                            method="POST">
                            @method('PUT')
                            @csrf
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <input type="text" placeholder="Masukkan Nomor Kontrak"
                                        ...
                                        value="{{ $item->nomorKontrak }}" required>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <input type="date" placeholder="Masukkan Awal Pelaksanaan"
                                        ...
                                        value="{{ $item->awalPelaksanaan }}" required>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <input type="date" placeholder="Masukkan Akhir Pelaksanaan"
                                        ...
                                        value="{{ $item->akhirPelaksanaan }}" required>
                                </div>
                            </div>
                            <div class="form-group">
