                    ...
                    <div class="d-md-flex">
                        ...
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                              <a class="dropdown-item" href="{{route('input-paket',['date'=>"2021"])}}">2021</a>
                              <a class="dropdown-item" href="{{route('input-paket',['date'=>"2022"])}}">2022</a>
                              <a class="dropdown-item" href="{{route('input-paket',['date'=>"2023"])}}">2023</a>
                            </div>
                        </div>
                    </div>
                    <h4 class="card-title col-md-10 mb-md-0 mb-3 align-self-center">SEKRETARIAT DAERAH</h4>
                    <h4 class="card-title col-md-10 mb-md-0 mb-3 align-self-center">BAGIAN PENGADAAN BARANG DAN JASA</h4>
                            ...
                            <tbody>
                                @if (Request::get('date'))
                                    ...
                                    <tr>
                                        ...
                                        <td>Rp. {{ number_format($item->inputPakets->sum('paguAnggaran'),0,',', '.')}}</td>
