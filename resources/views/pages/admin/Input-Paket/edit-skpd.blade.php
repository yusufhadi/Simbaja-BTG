                ...
                <div class="d-flex align-items-center">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Edit SKPD</li>
                        </ol>
                    </nav>
                </div>
            </div>
                    ...
                    <div class="card-body">
                        <form class="form-horizontal form-material mx-2" action="{{route('skpd.edit')}}" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <input type="text" placeholder="Masukkan Nama SKPD"
                                        class="form-control ps-0 form-control-line" name="name" value="{{$item->name}}">
                                </div>
                            </div>
                            <div class="form-group">
